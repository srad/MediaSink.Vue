      ...
      <div class="table-responsive border-secondary border m-0 p-0">
        <table class="table table-bordered m-0">
          ...
          <tr v-if="cpuInfo && cpuInfo.loadCpu">
            <td class="bg-light-subtle align-middle">CPU Load ({{ cpuInfo.loadCpu[0].cpu }}, {{
                mainCpuLoad.toFixed(1)
              }}%)
            </td>
          ...
          <tr v-if="diskInfo">
            <td class="bg-light-subtle align-middle">Disk usage ({{ diskInfo.pcent }})</td>
            <td class="align-middle">
              <div class="progress">
