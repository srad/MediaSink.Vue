...
# Vite env
ENV VITE_VUE_APP_APIURL $APP_API_URL
ENV VITE_VUE_APP_BASE $APP_BASE
ENV VITE_VUE_APP_NAME $APP_NAME
ENV VITE_VUE_APP_FILEURL $APP_FILEURL
ENV VITE_VUE_APP_SOCKETURL $APP_SOCKETURL
ENV VITE_VUE_APP_BUILD $APP_BUILD
